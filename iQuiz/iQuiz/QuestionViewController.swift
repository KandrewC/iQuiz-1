...
class QuestionViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        pickedAnswer = (answers[category]?[index][0])!
        currentQuestion.text = questions[category]?[index].0
    ...
    func pickerView(_ pickerView: UIPickerView, titleForRow row: Int, forComponent component: Int) -> String? {
        return answers[category]![index][row]
    }
    
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        pickedAnswer = answers[category]![index][row]
    }
    ...
    @IBAction func tapGo(_ sender: Any) {
       if isQuestion {
            ...
            let correctAnswer = questions[category]![index].1
            ...
            index += 1
        } else if index < (questions[category]?.count)! {
